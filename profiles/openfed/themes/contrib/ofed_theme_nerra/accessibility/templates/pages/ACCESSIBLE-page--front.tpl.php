 ...
 * @file
 *
 *  Line 23: Added role attribute.
 *  Line 33: Title attribute fix.
 *  Line 34: Alt attribute fix.
 *  Line 38: H1 element added to fix accessibility.
 *  Lines 44,48,69,73,124,126:
 *           Replaced section element with simple div for accessibility.
 *  Lines 92,116: Replaced div with main element for accessibility.
 *  Lines 78,80: Replaced div with nav element for accessibility.
 *  Line 79: Replaced h2 with span element to avoid error:
 *              "The heading structure is not logically nested"
 *  Line 100: Removed H1 element to fix accessibility.
 *  Line 111: Added skip-link referer.
 *  Line 120: Added role attribute.
 *  Line 136: Added role attributes.
 *
 */
...
<header role="banner">
  <div class="container">
    ...
    <?php endif; ?>
    <h1 class="element-invisible"><?php ($site_slogan) ? print $site_name . ', ' . $site_slogan : print $site_name; ?></h1>
...
<?php if (theme_get_setting('nerra_breadcrumb_display') && theme_get_setting('nerra_breadcrumb_homepage')): ?>
<!-- Region Breadcrumb -->
